...
| 002 | [Gate this repository's own dependency graph](002-dependency-footprint.md) | draft | A `depcheck` subcommand, so the argument for this repo's existence stays true |
